                    ...
                    <div className="row">
                        <div className="col col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="widget about-widget">
                                ...
                                <ul>
                                    <li>
                                        <Link onClick={ClickHandler} href="https://www.facebook.com/profile.php?id=61571123764217" target='_blank'>
                                            <i className="ti-facebook"></i>
                                        </Link>
                                    </li>
                                    <li>
                                        <Link onClick={ClickHandler} href="https://www.tiktok.com/@moderninteriorkenya" target='_blank' style={{display:"flex",alignItems:"center",justifyItems:"center"}}>
